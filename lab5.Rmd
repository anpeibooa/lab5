...
mysena <- senators[2][[1]][[1]]
#str(mysena)
mysena$person$birthday
mysena2 <- senators$objects
length(senators$objects)
mybirthday <-list()
for (i in c(1:length(senators$objects))){
  if(mysena2[[i]][["state"]]=="NC"){
    mybirthday <-list(mybirthday,mysena2[[i]][["person"]][["birthday"]])
